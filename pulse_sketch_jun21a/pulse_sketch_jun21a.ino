...
#define ENC_COUNT_REV 374 // always calibirate

// Encoder output to Arduino Interrupt pin
#define ENC_IN 3 // channel A output

// MD10C PWM connected to pin 10. power controller motor driver
#define PWM 10 
// MD10C DIR connected to pin 12. Motor driver direction pin
#define DIR 12 

// Analog pin for potentiometer. A0
int speedcontrol = 0;
...
//    motorPwm = map(analogRead(speedcontrol), 0, 1023, 0, 255);
    motorPwm = map(overide, 0, 1023, 0, 255);
